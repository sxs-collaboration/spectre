...
/// The normal component of the source term
/// coupling the M1 and hydro equations.
/// This is the source term for the evolution
/// of \f${\tilde E}\f$ (by convention, added
/// with a positive sign to \f${\tilde E}\f$
/// and a negative sign to the hydro variable
/// \f${\tilde \tau}\f$)
template <class Species>
...
/// The spatial components of source term
/// coupling the M1 and hydro equations.
/// i.e. \f${\tilde G}^a \gamma_{ia}\f$.
/// This is the source term for the evolution
/// of \f${\tilde S}_i\f$ (by convention, added
/// with a positive sign to the neutrino \f${\tilde S}_i\f$
/// and a negative sign to the hydro variable
/// \f${\tilde S}_i\f$)
template <typename Fr, class Species>
