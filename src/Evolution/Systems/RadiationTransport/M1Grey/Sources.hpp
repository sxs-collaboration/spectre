...
void compute_sources_impl(
    ...
    gsl::not_null<tnsr::i<DataVector, 3, Frame::System>*> source_tilde_s,
...
struct ComputeSources {
  using return_tags = tmpl::list<
      ::Tags::Source<Tags::TildeE<Frame::System, NeutrinoSpecies>>...,
      ::Tags::Source<Tags::TildeS<Frame::System, NeutrinoSpecies>>...>;

  using argument_tags = tmpl::list<
      Tags::TildeE<Frame::System, NeutrinoSpecies>...,
      Tags::TildeS<Frame::System, NeutrinoSpecies>...,
      Tags::TildeP<Frame::System, NeutrinoSpecies>..., gr::Tags::Lapse<>,
  ...
  static void apply(
      const gsl::not_null<db::item_type<
          Tags::TildeE<Frame::System, NeutrinoSpecies>>*>... sources_tilde_e,
      const gsl::not_null<db::item_type<
          Tags::TildeS<Frame::System, NeutrinoSpecies>>*>... sources_tilde_s,
