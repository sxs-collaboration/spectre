...
void compute_fluxes_impl(
    gsl::not_null<tnsr::I<DataVector, 3, Frame::System>*> tilde_e_flux,
    gsl::not_null<tnsr::Ij<DataVector, 3, Frame::System>*> tilde_s_flux,
    gsl::not_null<tnsr::I<DataVector, 3, Frame::System>*> tilde_s_M,
...
struct ComputeFluxes {
  using return_tags =
      tmpl::list<::Tags::Flux<Tags::TildeE<Frame::System, NeutrinoSpecies>,
                              tmpl::size_t<3>, Frame::System>...,
                 ::Tags::Flux<Tags::TildeS<Frame::System, NeutrinoSpecies>,
                              tmpl::size_t<3>, Frame::System>...>;
  ...
  static void apply(
      const gsl::not_null<db::item_type<
          ::Tags::Flux<Tags::TildeE<Frame::System, NeutrinoSpecies>,
                       tmpl::size_t<3>, Frame::System>>*>... tilde_e_flux,
      const gsl::not_null<db::item_type<
          ::Tags::Flux<Tags::TildeS<Frame::System, NeutrinoSpecies>,
                       tmpl::size_t<3>, Frame::System>>*>... tilde_s_flux,
    ...
    tnsr::I<DataVector, 3, Frame::System> tilde_s_M(get(lapse).size());
