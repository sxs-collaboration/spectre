 ...
 public:
  using argument_tags = tmpl::list<
      ...
      ::Tags::deriv<gr::Tags::SpacetimeMetric<Dim>, tmpl::size_t<Dim>,
                    Frame::System>,
      ::Tags::deriv<Tags::Pi<Dim>, tmpl::size_t<Dim>, Frame::System>,
      ::Tags::deriv<Tags::Phi<Dim>, tmpl::size_t<Dim>, Frame::System>,
...
struct ComputeNormalDotFluxes {
 public:
  using argument_tags = tmpl::list<
      ...
      gr::Tags::Shift<Dim>, gr::Tags::InverseSpatialMetric<Dim>,
      ::Tags::Normalized<::Tags::UnnormalizedFaceNormal<Dim, Frame::System>>>;
...
struct UpwindFlux {
 public:
  ...
  using package_tags = tmpl::list<
      gr::Tags::SpacetimeMetric<Dim, Frame::System, DataVector>,
      Tags::Pi<Dim, Frame::System>, Tags::Phi<Dim, Frame::System>,
  ...
  void operator()(
      gsl::not_null<tnsr::aa<DataVector, Dim, Frame::System>*>
          psi_normal_dot_numerical_flux,
      gsl::not_null<tnsr::aa<DataVector, Dim, Frame::System>*>
          pi_normal_dot_numerical_flux,
      gsl::not_null<tnsr::iaa<DataVector, Dim, Frame::System>*>
      ...
      const tnsr::i<DataVector, Dim, Frame::System>& interface_unit_normal_ext)
      const noexcept;
};
}  // namespace GeneralizedHarmonic
