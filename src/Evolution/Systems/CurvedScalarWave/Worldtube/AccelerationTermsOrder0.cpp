...
void acceleration_terms_0(
  ...
  get(get<::Tags::dt<CurvedScalarWave::Tags::Psi>>(*result)) =
      ...
      (-3. * d_25 * d_42 * dv_27 * dv_38 * dv_39 +
       d_25 * d_42 * dv_29 *
           (4. * M * d_14 * d_20 * dv_2 * dv_38 * ft +
            2. * d_0 * d_14 * dv_14 * dv_38 * fx +
            2. * d_0 * d_14 * dv_17 * dv_38 * fy - d_20 * dv_24 * dv_7 * dt_ft -
            dv_10 * dv_40 - dv_10 * dv_43 - dv_10 * dv_8 * dt_ft -
            dv_15 * dv_44 - dv_18 * dv_45 - dv_20 * dv_36 - dv_20 * dv_42 -
            dv_21 * dv_50 - 14 * dv_22 * dv_35 * ft * rpdot - dv_22 * dv_40 -
            dv_22 * dv_43 - dv_22 * dv_44 * fx - dv_22 * dv_45 * fy -
            dv_23 * dv_50 - dv_25 * dv_41 -
            4 * dv_35 * dv_51 * ft * rp * rp * rp * rp * rp * rp * rp -
  ...
  get<0>(get<::Tags::deriv<CurvedScalarWave::Tags::Psi, tmpl::size_t<3>,
      ...
      -dv_69 * (d_35 * dv_55 + d_36 * dv_53 + d_45 * dv_54 + d_45 * dv_57 +
                ...
                dv_62 * dv_63 - dv_62 * dv_65 - dv_62 * dv_66);
  get<1>(get<::Tags::deriv<CurvedScalarWave::Tags::Psi, tmpl::size_t<3>,
      ...
      -dv_69 * (d_17 * dv_55 + d_18 * dv_54 + d_18 * dv_57 + d_39 * dv_53 +
                ...
                dv_63 * dv_71 - dv_65 * dv_71 - dv_66 * dv_71);
  get<2>(get<::Tags::deriv<CurvedScalarWave::Tags::Psi, tmpl::size_t<3>,
                           Frame::Inertial>>(*result)) =
      d_23 * z * (dv_26 + dv_63 + dv_65 + dv_66) /
      (dv_11 * dv_11 * sqrt(dv_11));
}
}  // namespace CurvedScalarWave::Worldtube
