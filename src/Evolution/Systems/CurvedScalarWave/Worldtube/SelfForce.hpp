...
/*!
 * \brief Computes the second time derivative of scalar self-force per unit mass
 * by applying the chain rule.
 */
template <size_t Dim>
 ...
 * mass $f^\alpha$ along the four velocity $u^\beta$, i.e. $u^\beta \nabla_\beta
 * f^\alpha$.
 */
template <size_t Dim>
 ...
 * self-force per unit mass $f^\alpha along$ the four velocity $u^\beta$, i.e.
 * $\frac{d}{dt}u^\beta \nabla_\beta f^\alpha$.
 */
template <size_t Dim>
