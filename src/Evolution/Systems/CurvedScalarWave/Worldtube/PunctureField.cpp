...
void puncture_field_1(
  ...
  const double d_135 = -6 * M * d_23 * d_96 + d_10 * d_25 * d_96 + d_16;
  ...
  dv_124 = dv_1 * dv_122 + 11 * dv_112 + 11 * dv_118 - 4.0 * dv_119;
  ...
  dv_160 = -2 * Dy * d_1 * d_4 + d_4 * dv_154 - d_5 * dv_154 + 2.0 * dv_150;
  DataVector& dv_161 = temps.at(27);
  dv_161 = d_98 * dv_27;
  DataVector& dv_162 = temps.at(110);
  dv_162 = -10 * Dx * Dy * d_1 * d_10 * d_19 * d_2 -
  ...
  dv_207 = -d_4 * dv_104 - d_5 * dv_101 + 14 * dv_12;
  ...
  dv_223 = -3 * Dy * d_1 * d_4 + 3.0 * dv_150;
  ...
  dv_348 = -2 * d_129 * d_22 * d_41 * dv_87 + 4.0 * dv_276 * dv_85 -
      ...
      ((1.0 / 2.0) * M * d_10 * d_26 * dv_163 * dv_164 * dv_72 *
       ...
       d_16 * dv_268 *
           (-M * d_6 * dv_237 * dv_245 * dv_246 +
                      ...
                      d_69 *
                          (d_29 *
                               (-Dy * d_4 * d_70 * dv_257 +
                                ...
                                d_72 * (-dv_149 * dv_23 - 11 * dv_23 * dv_53 +
                                        dv_259) -
                                d_73 * dv_255 +
                                d_73 * (-4 * d_1 * dv_260 + dv_208 * dv_53 +
                                        dv_259 + dv_261 * dv_54) +
                                d_74 * (7 * Dy * d_1 * dv_17 +
                                        22 * d_1 * dv_260 - 68 * dv_0 * dv_54 -
                                        dv_209 * dv_53 - 22 * dv_258) +
            ...
            dv_232 * dv_237 * dv_239 + 24 * dv_242 * dv_244) -
                    ...
                    (d_109 *
                         (d_128 * dv_319 +
                          d_14 * (Dx * d_72 * (-dv_116 + dv_15 - dv_261) +
                                  ...
                                  d_70 * dv_11 * dv_257 -
                                  30 * d_71 * dv_0 * dv_54 - d_71 * dv_255) +
      ...
      ((1.0 / 6.0) * M * d_134 * d_16 * d_82 * dv_184 * dv_216 +
       ...
       dv_328 *
           (d_116 * d_134 * dv_303 + d_134 * dv_200 * dv_306 +
            ...
            48 * d_96 * dv_244 * dv_353 - dv_310 - dv_314 +
            dv_327 *
