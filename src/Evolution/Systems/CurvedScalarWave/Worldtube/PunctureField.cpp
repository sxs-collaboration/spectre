...
void puncture_field(
  ...
  if (order == 0) {
    ...
    ERROR(
        "Puncture order is only implemented up to order 0 but you requested "
        "order "
        << order);
  }
}
...
void puncture_field_0(
  ...
  dv_64 = 12 * d_19 * dv_15;
  DataVector& dv_manual = get(get<Tags::Psi>(*result));
  dv_manual = d_0 * d_56 *
  ...
  get<0>(get<::Tags::deriv<Tags::Psi, tmpl::size_t<3>, Frame::Inertial>>(
      *result)) = (1.0 / 2.0) * M * d_25 * d_32 * d_40 * dv_47 * dv_51 * dv_55 *
                      dv_85 * r0 *
                  ...
                  dv_103 * (-d_74 * dv_89 + dv_95) -
                  dv_96 * (-d_53 * dv_89 + dv_95);
  get<1>(get<::Tags::deriv<Tags::Psi, tmpl::size_t<3>, Frame::Inertial>>(
      *result)) = (1.0 / 2.0) * M * d_25 * d_32 * d_40 * dv_47 * dv_51 * dv_55 *
                      dv_85 * r0 *
                      (Dy * d_18 - d_22 * dv_106 + d_66 * dv_105 +
                       d_77 * dv_99 + dv_107 * r0) -
                  dv_101 * (-d_11 * dv_98 + 4.0 * d_21 * d_42 * dv_49 * dv_88 -
                            d_45 * d_78 * dv_78 -
                            dv_97 * (dv_4 - 2.0 * dv_86 + 3.0 * dv_87)) -
                  dv_102 * (Dy + d_48 * dv_4 + d_48 * dv_87 - d_78 * dv_49) -
                  dv_103 * (d_74 * dv_104 + dv_108) -
                  dv_96 * (d_53 * dv_104 + dv_108);
