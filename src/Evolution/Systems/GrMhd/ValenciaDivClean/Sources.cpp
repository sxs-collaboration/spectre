...
void densitized_stress(
    const gsl::not_null<tnsr::II<DataVector, 3, Frame::Physical>*> result,
...
struct DensitizedStress {
  using type = tnsr::II<DataVector, 3, Frame::Physical>;
};
}  // namespace
...
void ComputeSources::apply(
  ...
  Variables<tmpl::list<
      ...
      gr::Tags::SpatialChristoffelFirstKind<3, Frame::Physical, DataVector>,
      gr::Tags::SpatialChristoffelSecondKind<3, Frame::Physical, DataVector>,
      gr::Tags::TraceSpatialChristoffelSecondKind<3, Frame::Physical,
                                                  DataVector>>>
  ...
  densitized_stress(
      ...
      &get<0, 0, 0>(
          get<gr::Tags::SpatialChristoffelFirstKind<3, Frame::Physical,
  ...
  auto& trace_of_christoffel_second_kind =
      get<gr::Tags::TraceSpatialChristoffelSecondKind<3, Frame::Physical,
                                                      DataVector>>(
          temp_tensors);
