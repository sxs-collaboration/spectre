...
void ComputeFluxes::apply(
    const gsl::not_null<tnsr::I<DataVector, 3, Frame::System>*> tilde_d_flux,
    const gsl::not_null<tnsr::I<DataVector, 3, Frame::System>*> tilde_tau_flux,
    const gsl::not_null<tnsr::Ij<DataVector, 3, Frame::System>*> tilde_s_flux,
    const gsl::not_null<tnsr::IJ<DataVector, 3, Frame::System>*> tilde_b_flux,
    const gsl::not_null<tnsr::I<DataVector, 3, Frame::System>*> tilde_phi_flux,
  ...
  Variables<tmpl::list<
      hydro::Tags::SpatialVelocityOneForm<DataVector, 3, Frame::System>,
      hydro::Tags::MagneticFieldOneForm<DataVector, 3, Frame::System>,
  ...
  auto& spatial_velocity_one_form =
      get<hydro::Tags::SpatialVelocityOneForm<DataVector, 3, Frame::System>>(
          temp_tensors);
  raise_or_lower_index(make_not_null(&spatial_velocity_one_form),
                       spatial_velocity, spatial_metric);
  auto& magnetic_field_one_form =
      get<hydro::Tags::MagneticFieldOneForm<DataVector, 3, Frame::System>>(
          temp_tensors);
  ...
  tnsr::i<DataVector, 3, Frame::System>& lapse_b_over_w =
      get<hydro::Tags::SpatialVelocityOneForm<DataVector, 3, Frame::System>>(
          temp_tensors);
