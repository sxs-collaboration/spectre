...
struct ComputeFluxes {
  ...
  static void apply(
      gsl::not_null<tnsr::I<DataVector, 3, Frame::Physical>*> tilde_d_flux,
      gsl::not_null<tnsr::I<DataVector, 3, Frame::Physical>*> tilde_tau_flux,
      gsl::not_null<tnsr::Ij<DataVector, 3, Frame::Physical>*> tilde_s_flux,
      gsl::not_null<tnsr::IJ<DataVector, 3, Frame::Physical>*> tilde_b_flux,
      gsl::not_null<tnsr::I<DataVector, 3, Frame::Physical>*> tilde_phi_flux,
