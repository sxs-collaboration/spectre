 ...
 * internal energy density, electron fraction, magnetic field, and divergence
 * cleaning field.  Furthermore \f$\gamma\f$ is the determinant of the spatial
 * metric, \f$\rho\f$ is the rest mass density, \f$W = 1/\sqrt{1-v_i v^i}\f$ is
 * the Lorentz factor, \f$h = 1 + \epsilon + \frac{p}{\rho}\f$ is the specific
 * enthalpy, \f$Y_e\f$ is the electron fraction, \f$v^i\f$ is the spatial
...
struct ConservativeFromPrimitive {
  ...
  static void apply(
      ...
      gsl::not_null<Scalar<DataVector>*> tilde_electron_d,
