...
struct ZeroMhdTimeDerivatives {
  ...
  using argument_tags = tmpl::list<domain::Tags::Element<3>,
                                   evolution::dg::Tags::OnlyDgBlockIds<3>>;

  template <class DtTagsList>
  static void apply(const gsl::not_null<Variables<DtTagsList>*> dt_variables,
