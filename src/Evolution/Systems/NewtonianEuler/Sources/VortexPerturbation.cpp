...
void VortexPerturbation<3>::apply(
  ...
  Variables<
      tmpl::list<::Tags::TempScalar<0>, ::Tags::TempI<1, 3, Frame::Physical>,
                 ::Tags::TempScalar<2>>>
  ...
  auto& vortex_momentum_density =
      get<::Tags::TempI<1, 3, Frame::Physical>>(temp_buffer);
  ...
  NewtonianEuler::ConservativeFromPrimitive<3>::apply(
      ...
      get<Tags::Velocity<DataVector, 3, Frame::Physical>>(vortex_primitives),
  ...
  get(*source_energy_density) =
      (get(vortex_energy_density) +
       ...
       vortex_momentum_density.get(2) *
           get<2>(get<Tags::Velocity<DataVector, 3, Frame::Physical>>(
               vortex_primitives))) *
      get(*source_mass_density_cons);
