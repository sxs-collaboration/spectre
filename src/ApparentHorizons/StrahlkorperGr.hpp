 ...
 * of James B. Hartle's Gravity: An Introduction to Einstein's General
 * Relativity. This function computes the irreducible mass from the area of a
 * horizon. Specifically, computes \f$M_\mathrm{irr}=\sqrt{\frac{A}{16\pi}}\f$
 */
