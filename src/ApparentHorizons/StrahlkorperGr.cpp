...
template tnsr::i<DataVector, 3, Frame::Physical>
StrahlkorperGr::unit_normal_one_form<Frame::Physical>(
    const tnsr::i<DataVector, 3, Frame::Physical>& normal_one_form,
    const DataVector& one_over_one_form_magnitude) noexcept;

template tnsr::ii<DataVector, 3, Frame::Physical>
StrahlkorperGr::grad_unit_normal_one_form<Frame::Physical>(
    const tnsr::i<DataVector, 3, Frame::Physical>& r_hat,
    const DataVector& radius,
    const tnsr::i<DataVector, 3, Frame::Physical>& unit_normal_one_form,
    const tnsr::ii<DataVector, 3, Frame::Physical>& d2x_radius,
    const DataVector& one_over_one_form_magnitude,
    const tnsr::Ijj<DataVector, 3, Frame::Physical>&
        christoffel_2nd_kind) noexcept;

template tnsr::II<DataVector, 3, Frame::Physical>
StrahlkorperGr::inverse_surface_metric<Frame::Physical>(
    const tnsr::I<DataVector, 3, Frame::Physical>& unit_normal_vector,
    const tnsr::II<DataVector, 3, Frame::Physical>&
        upper_spatial_metric) noexcept;

template Scalar<DataVector> StrahlkorperGr::expansion<Frame::Physical>(
    const tnsr::ii<DataVector, 3, Frame::Physical>& grad_normal,
    const tnsr::II<DataVector, 3, Frame::Physical>& inverse_surface_metric,
    const tnsr::ii<DataVector, 3, Frame::Physical>&
        extrinsic_curvature) noexcept;

template tnsr::ii<DataVector, 3, Frame::Physical>
StrahlkorperGr::extrinsic_curvature<Frame::Physical>(
    const tnsr::ii<DataVector, 3, Frame::Physical>& grad_normal,
    const tnsr::i<DataVector, 3, Frame::Physical>& unit_normal_one_form,
    const tnsr::I<DataVector, 3, Frame::Physical>& unit_normal_vector) noexcept;

template Scalar<DataVector> StrahlkorperGr::ricci_scalar<Frame::Physical>(
    const tnsr::ii<DataVector, 3, Frame::Physical>& spatial_ricci_tensor,
    const tnsr::I<DataVector, 3, Frame::Physical>& unit_normal_vector,
    const tnsr::ii<DataVector, 3, Frame::Physical>& extrinsic_curvature,
    const tnsr::II<DataVector, 3, Frame::Physical>&
        upper_spatial_metric) noexcept;

template Scalar<DataVector> StrahlkorperGr::area_element<Frame::Physical>(
    const tnsr::ii<DataVector, 3, Frame::Physical>& spatial_metric,
    const StrahlkorperTags::aliases::Jacobian<Frame::Physical>& jacobian,
    const tnsr::i<DataVector, 3, Frame::Physical>& normal_one_form,
    const DataVector& radius,
    const tnsr::i<DataVector, 3, Frame::Physical>& r_hat) noexcept;

template Scalar<DataVector>
StrahlkorperGr::euclidean_area_element<Frame::Physical>(
    const StrahlkorperTags::aliases::Jacobian<Frame::Physical>& jacobian,
    const tnsr::i<DataVector, 3, Frame::Physical>& normal_one_form,
    const DataVector& radius,
    const tnsr::i<DataVector, 3, Frame::Physical>& r_hat) noexcept;
...
template double StrahlkorperGr::euclidean_surface_integral_of_vector(
    const Scalar<DataVector>& area_element,
    const tnsr::I<DataVector, 3, Frame::Physical>& vector,
    const tnsr::i<DataVector, 3, Frame::Physical>& normal_one_form,
    const Strahlkorper<Frame::Physical>& strahlkorper) noexcept;

template Scalar<DataVector> StrahlkorperGr::spin_function<Frame::Physical>(
    const StrahlkorperTags::aliases::Jacobian<Frame::Physical>& tangents,
    const YlmSpherepack& ylm,
    const tnsr::I<DataVector, 3, Frame::Physical>& unit_normal_vector,
    const Scalar<DataVector>& area_element,
    const tnsr::ii<DataVector, 3, Frame::Physical>&
...
template double StrahlkorperGr::dimensionful_spin_magnitude<Frame::Physical>(
    const Scalar<DataVector>& ricci_scalar,
    const Scalar<DataVector>& spin_function,
    const tnsr::ii<DataVector, 3, Frame::Physical>& spatial_metric,
    const StrahlkorperTags::aliases::Jacobian<Frame::Physical>& tangents,
...
template std::array<double, 3> StrahlkorperGr::spin_vector<Frame::Physical>(
