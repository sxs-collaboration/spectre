...
void register_with_charm<1>() {
  PUPable_reg(
      SINGLE_ARG(CoordinateMap<Frame::Logical, Frame::Physical, Affine>));
  PUPable_reg(
      SINGLE_ARG(CoordinateMap<Frame::Logical, Frame::Physical,
...
void register_with_charm<2>() {
  PUPable_reg(
      SINGLE_ARG(CoordinateMap<Frame::Logical, Frame::Physical, Affine2D>));
  PUPable_reg(
      SINGLE_ARG(CoordinateMap<Frame::Logical, Frame::Physical,
                               CoordinateMaps::DiscreteRotation<2>, Affine2D>));
  PUPable_reg(SINGLE_ARG(
      CoordinateMap<Frame::Logical, Frame::Physical, Equiangular2D>));
  PUPable_reg(SINGLE_ARG(CoordinateMap<Frame::Logical, Frame::Physical,
                                       CoordinateMaps::Identity<2>>));
  PUPable_reg(
      SINGLE_ARG(CoordinateMap<Frame::Logical, Frame::Physical, Wedge2D>));
}
template <>
void register_with_charm<3>() {
  PUPable_reg(
      SINGLE_ARG(CoordinateMap<Frame::Logical, Frame::Physical, Affine3D>));
  PUPable_reg(
      SINGLE_ARG(CoordinateMap<Frame::Logical, Frame::Physical,
                               CoordinateMaps::DiscreteRotation<3>, Affine3D>));
  PUPable_reg(SINGLE_ARG(
      CoordinateMap<Frame::Logical, Frame::Physical, Equiangular3D>));
  PUPable_reg(SINGLE_ARG(
      CoordinateMap<Frame::Logical, Frame::Physical, Equiangular3DPrism>));
  PUPable_reg(SINGLE_ARG(
      CoordinateMap<Frame::Logical, Frame::Physical, CoordinateMaps::Frustum>));
  PUPable_reg(
      SINGLE_ARG(CoordinateMap<Frame::Logical, Frame::Physical, Wedge3D>));
  PUPable_reg(SINGLE_ARG(CoordinateMap<Frame::Logical, Frame::Physical, Wedge3D,
                                       EquatorialCompression>));
  PUPable_reg(
      SINGLE_ARG(CoordinateMap<Frame::Logical, Frame::Physical, Wedge3DPrism>));
  PUPable_reg(SINGLE_ARG(CoordinateMap<Frame::Logical, Frame::Physical, Wedge3D,
