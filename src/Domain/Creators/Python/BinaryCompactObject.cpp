  ...
  py::class_<domain::creators::BinaryCompactObject<false>, DomainCreator<3>>(
      ...
      .def(py::init(
               [](const double inner_radius_object_a,
                  ...
                  const std::optional<double> cutting_plane_position,
           ...
           py::arg("use_logarithmic_map_b"), py::arg("cutting_plane_position"),
           py::arg("center_of_mass_offset"), py::arg("envelope_radius"),
           py::arg("outer_radius"), py::arg("cube_scale"),
