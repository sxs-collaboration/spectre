  ...
  py::class_<BCO, DomainCreator<3>>(m, "BinaryCompactObject")
      .def(py::init(
               [](const double inner_radius_object_a,
                  ...
                  const bool excise_a,
                  const std::optional<double> shell_log_map_strength_a,
                  const std::optional<double> cube_log_map_strength_a,
                  const double inner_radius_object_b,
                  const double outer_radius_object_b, const double x_coord_b,
                  const bool excise_b,
                  const std::optional<double> shell_log_map_strength_b,
                  const std::optional<double> cube_log_map_strength_b,
                 ...
                 return BCO{
                     BCO::Object{inner_radius_object_a, outer_radius_object_a,
                                 x_coord_a, excise_a, shell_log_map_strength_a,
                                 cube_log_map_strength_a},
                     BCO::Object{inner_radius_object_b, outer_radius_object_b,
                                 x_coord_b, excise_b, shell_log_map_strength_b,
                                 cube_log_map_strength_b},
           ...
           py::arg("shell_log_map_strength_a"),
           py::arg("cube_log_map_strength_a"), py::arg("inner_radius_b"),
           py::arg("outer_radius_b"), py::arg("x_coord_b"), py::arg("excise_b"),
           py::arg("shell_log_map_strength_b"),
           py::arg("cube_log_map_strength_b"), py::arg("center_of_mass_offset"),
