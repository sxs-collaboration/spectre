...
Domain<3> BinaryCompactObject<UseWorldtube>::create_domain() const {
  ...
  if (use_single_block_a_) {
    ...
    Maps maps_center_A =
        spherical_shells_coordinate_maps<Frame::BlockLogical, Frame::Inertial>(
            ...
            1.0, use_equiangular_map_, offset_a_optional, false, {},
            object_A_radial_distribution,
    ...
    Maps maps_cube_A =
        spherical_shells_coordinate_maps<Frame::BlockLogical, Frame::Inertial>(
            ...
            0.0, use_equiangular_map_, offset_a_optional, false, {},
            {domain::CoordinateMaps::Distribution::Linear},
            {domain::CoordinateMaps::ShellType::Cubed}, ShellWedges::All,
            M_PI_2, translation_A);
  ...
  if (use_single_block_b_) {
    ...
    Maps maps_cube_B =
        spherical_shells_coordinate_maps<Frame::BlockLogical, Frame::Inertial>(
            ...
            0.0, use_equiangular_map_, offset_b_optional, false, {},
            {domain::CoordinateMaps::Distribution::Linear},
            {domain::CoordinateMaps::ShellType::Cubed}, ShellWedges::All,
            M_PI_2, translation_B);
  ...
  Maps maps_outer_shell =
      spherical_shells_coordinate_maps<Frame::BlockLogical, Frame::Inertial>(
          ...
          std::nullopt, true, {}, {radial_distribution_outer_shell_},
          {domain::CoordinateMaps::ShellType::Cubed}, ShellWedges::All,
          opening_angle_);
