...
std::array<tt::remove_cvref_wrap_t<T>, 3> Shape<TransitionFunc>::operator()(
  ...
  const auto centered_coords = center_coordinates_(source_coords);
...
Shape<TransitionFunc>::jacobian(
  ...
  get<0, 1>(result) = -gsl::at(centered_coords, 0) *
                      (gsl::at(transition_func_gradient, 1) * distorted_radii +
                       target_gradient_y * transition_func_over_radius);
  get<0, 2>(result) = -gsl::at(centered_coords, 0) *
                      (gsl::at(transition_func_gradient, 2) * distorted_radii +
                       target_gradient_z * transition_func_over_radius);
  get<1, 0>(result) = -gsl::at(centered_coords, 1) *
                      (gsl::at(transition_func_gradient, 0) * distorted_radii +
                       target_gradient_x * transition_func_over_radius);
  get<1, 1>(result) = -gsl::at(centered_coords, 1) *
                      (gsl::at(transition_func_gradient, 1) * distorted_radii +
                       target_gradient_y * transition_func_over_radius);
  get<1, 2>(result) = -gsl::at(centered_coords, 1) *
                      (gsl::at(transition_func_gradient, 2) * distorted_radii +
                       target_gradient_z * transition_func_over_radius);
  get<2, 0>(result) = -gsl::at(centered_coords, 2) *
                      (gsl::at(transition_func_gradient, 0) * distorted_radii +
                       target_gradient_x * transition_func_over_radius);
  get<2, 1>(result) = -gsl::at(centered_coords, 2) *
                      (gsl::at(transition_func_gradient, 1) * distorted_radii +
                       target_gradient_y * transition_func_over_radius);
  get<2, 2>(result) = -gsl::at(centered_coords, 2) *
                      (gsl::at(transition_func_gradient, 2) * distorted_radii +
                       target_gradient_z * transition_func_over_radius);
