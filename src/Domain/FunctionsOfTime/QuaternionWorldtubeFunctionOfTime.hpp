 ...
 * QuaternionWorldtubeFunctionOfTime. The `update` function is then just a
 * wrapper around the internal `PiecewisePolynomial::update` function with the
 * addition that it then updates the stored quaternions as well.
 *
...
class QuaternionWorldtubeFunctionOfTime : public FunctionOfTime {
 public:
  QuaternionWorldtubeFunctionOfTime();
  QuaternionWorldtubeFunctionOfTime(QuaternionWorldtubeFunctionOfTime&&);
  QuaternionWorldtubeFunctionOfTime(const QuaternionWorldtubeFunctionOfTime&);
  QuaternionWorldtubeFunctionOfTime& operator=(
      QuaternionWorldtubeFunctionOfTime&&);
  QuaternionWorldtubeFunctionOfTime& operator=(
      const QuaternionWorldtubeFunctionOfTime&);
  ~QuaternionWorldtubeFunctionOfTime() override;
  ...
  // LCOV_EXCL_START
  explicit QuaternionWorldtubeFunctionOfTime(CkMigrateMessage* /*unused*/);
  // LCOV_EXCL_STOP
  ...
  WRAPPED_PUPable_decl_template(
      QuaternionWorldtubeFunctionOfTime<MaxDeriv>);  // NOLINT
 ...
 private:
  ...
  friend bool operator==(  // NOLINT(readability-redundant-declaration)
      const QuaternionWorldtubeFunctionOfTime<LocalMaxDeriv>& lhs,
      const QuaternionWorldtubeFunctionOfTime<LocalMaxDeriv>& rhs);

  template <size_t LocalMaxDeriv>
  friend std::ostream& operator<<(  // NOLINT(readability-redundant-declaration)
      std::ostream& os, const QuaternionWorldtubeFunctionOfTime<LocalMaxDeriv>&
                            quaternion_f_of_t);
...
/// \cond
template <size_t MaxDeriv>
PUP::able::PUP_ID QuaternionWorldtubeFunctionOfTime<MaxDeriv>::my_PUP_ID =
    0;  // NOLINT
/// \endcond
}  // namespace domain::FunctionsOfTime
