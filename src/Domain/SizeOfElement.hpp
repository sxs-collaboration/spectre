 ...
 * \brief Compute the system-coordinate size of an element along each of its
 * logical directions.
 *
 * For each logical direction, compute the mean position (in system
...
/// \ingroup ComputationalDomainGroup
/// The system-coordinate size of an element along each of its logical
/// directions.
template <size_t VolumeDim>
