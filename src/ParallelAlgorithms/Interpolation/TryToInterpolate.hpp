...
#include "ParallelAlgorithms/Interpolation/IrregularInterpolant.hpp"
  ...
  db::mutate_apply<tmpl::list<Tags::InterpolatedVarsHolders<Metavariables>>,
      ...
      [&temporal_id](
        ...
        for (const auto& volume_info_outer : volume_vars_info) {
          ...
          std::vector<ElementId<Metavariables::domain_dim>> element_ids;
          ...
          for (const auto& element_coord_pair : element_coord_holders) {
            ...
            // Now interpolate.
            intrp::Irregular<Metavariables::domain_dim> interpolator(
