...
double lagrange_polynomial(const Iterator& index_point, double x,
...
double lagrange_polynomial(size_t j, double x,
  ...
  return lagrange_polynomial(std::next(control_points_begin, j_diff), x,
                             control_points_begin, control_points_end);
}
