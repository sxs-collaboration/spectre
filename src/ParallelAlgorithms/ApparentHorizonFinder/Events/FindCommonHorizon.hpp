...
/*!
 * \brief Temporary copy of common horizon find event that works with the
 * rewrite
 */
template <typename HorizonMetavars, typename Tensors,
          typename NonTensorComputeTagsList = tmpl::list<>>
class FindCommonHorizon2;

template <typename HorizonMetavars, typename... Tensors,
          typename... NonTensorComputeTags>
class FindCommonHorizon2<HorizonMetavars, tmpl::list<Tensors...>,
 ...
 public:
  /// \cond
  explicit FindCommonHorizon2(CkMigrateMessage* /*unused*/) {}
  using PUP::able::register_constructor;
  WRAPPED_PUPable_decl_template(FindCommonHorizon2);  // NOLINT
  /// \endcond
...
template <typename HorizonMetavars, typename... Tensors,
          typename... NonTensorComputeTags>
PUP::able::PUP_ID
    FindCommonHorizon2<HorizonMetavars, tmpl::list<Tensors...>,
