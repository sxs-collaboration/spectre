 ...
 * `compute_cells()`. Non-tensor-product topologies (Triangle, Tetrahedron,
 * Wedge) are necessary for filled cylinders, shells, and balls.
 *
 ...
 *
 * The mapping is: Line=2, Triangle=4, Quad=5, Tetrahedron=6, Wedge=8,
 * Hexahedron=9.
