...
struct Metavariables {
  ...
  using linear_solver = LinearSolver::gmres::Gmres<
      ...
      SolveIrrotationalBns::OptionTags::LinearSolverGroup, true,
  ...
  using multigrid = LinearSolver::multigrid::Multigrid<
      ...
      SolveIrrotationalBns::OptionTags::MultigridGroup,
  ...
  using subdomain_operator =
      elliptic::dg::subdomain_operator::SubdomainOperator<
          system, SolveIrrotationalBns::OptionTags::SchwarzSmootherGroup>;
  using schwarz_smoother = LinearSolver::Schwarz::Schwarz<
      typename multigrid::smooth_fields_tag,
      SolveIrrotationalBns::OptionTags::SchwarzSmootherGroup,
      subdomain_operator, tmpl::list<>, typename multigrid::smooth_source_tag,
