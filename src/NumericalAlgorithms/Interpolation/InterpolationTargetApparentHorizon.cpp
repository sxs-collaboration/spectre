...
// least two frames.
template struct ApparentHorizon<Frame::System>;
template bool operator==(const ApparentHorizon<Frame::System>& lhs,
                         const ApparentHorizon<Frame::System>& rhs) noexcept;
template bool operator!=(const ApparentHorizon<Frame::System>& lhs,
                         const ApparentHorizon<Frame::System>& rhs) noexcept;
