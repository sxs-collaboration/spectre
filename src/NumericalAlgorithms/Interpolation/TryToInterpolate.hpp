...
struct has_compute_vars_to_interpolate {
  using type = std::false_type;
};
template <typename T>
struct has_compute_vars_to_interpolate<
    T, std::void_t<typename T::compute_vars_to_interpolate>> {
  using type = std::true_type;
};
template <typename T>
constexpr bool has_compute_vars_to_interpolate_v =
    has_compute_vars_to_interpolate<T>::type::value;
