...
struct FindApparentHorizon {
  ...
  static bool apply(
    ...
    const auto& inv_g =
        db::get<::gr::Tags::InverseSpatialMetric<3, Frame::System>>(*box);
    const auto& ex_curv =
        db::get<::gr::Tags::ExtrinsicCurvature<3, Frame::System>>(*box);
    const auto& christoffel =
        db::get<::gr::Tags::SpatialChristoffelSecondKind<3, Frame::System>>(
            *box);
    ...
    db::mutate<::ah::Tags::FastFlow,
               StrahlkorperTags::Strahlkorper<Frame::System>>(
        box, [&inv_g, &ex_curv, &christoffel, &status_and_info](
                 const gsl::not_null<::FastFlow*> fast_flow,
                 const gsl::not_null<::Strahlkorper<Frame::System>*>
                     strahlkorper) noexcept {
          status_and_info =
              fast_flow->template iterate_horizon_finder<Frame::System>(
    ...
    db::mutate_apply<tmpl::list<::Tags::Variables<vars_tags>>,
                     tmpl::list<StrahlkorperTags::Strahlkorper<Frame::System>,
                                ::ah::Tags::FastFlow>>(
        [](const gsl::not_null<db::item_type<::Tags::Variables<vars_tags>>*>
               vars,
           const db::const_item_type<
               StrahlkorperTags::Strahlkorper<Frame::System>>& strahlkorper,
