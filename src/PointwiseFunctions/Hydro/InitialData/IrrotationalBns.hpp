...
void rotational_shift(
    const gsl::not_null<tnsr::I<DataVector, 3>*> rotational_shift,
...
void rotational_shift_stress(
    const gsl::not_null<tnsr::Ij<DataVector, 3>*> rotational_shift_stress,
    const tnsr::I<DataVecotr, 3>& rotational_shift,
...
void divergence_rotational_shift_over_lapse(
    const gsl::not_null<tnsr::i<DataVector, 3>*> divergence_rotational_shift,
    const tnsr::I<DataVector, 3>& shift,
...
template <typename DataType>
tnsr::i<DataVector, 3> divergence_spatial_rotational_killing_vector(
    const gsl::not_null<tnsr::I<DataVector, 3>*> result,
    const tnsr::I<DataVector, 3>& x,
    const Scalar<DataType> local_angular_velocity_around_z,
    const Scalar<DataType> determinant_spatial_metric);
