...
class EquationOfState<IsRelativistic, 3> : public PUP::able {
 public:
   ...
   * and we can expand
   * \f[
   * \frac{\partial p}{\rho} |_{e, Y_e} = \frac{\partial e}{\partial
   ...
   * by using \f$ \frac{\pd e}{\pd \epsilon}|_{\rho, Y_e} = 1 \f$
   * \f[
   * c_s^2   =
   * \frac{\rho}{h}\frac{\partial p}{\rho} |_{\epsilon, Y_e} +
