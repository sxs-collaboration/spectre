...
class RiemannProblem : public MarkAsAnalyticSolution {
 ...
 public:
  ...
  tuples::TaggedTuple<Tags...> variables(
      const tnsr::I<DataType, Dim, Frame::System>& x, double t,
    ...
    tnsr::I<DataType, Dim, Frame::System> x_shifted(x);
 ...
 private:
  ...
  auto variables(const tnsr::I<DataType, Dim, Frame::System>& x_shifted,
  ...
  template <typename DataType>
  auto variables(
      const tnsr::I<DataType, Dim, Frame::System>& x_shifted, double t,
