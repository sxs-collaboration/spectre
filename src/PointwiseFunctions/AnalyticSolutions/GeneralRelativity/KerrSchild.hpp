...
class KerrSchild : public MarkAsAnalyticSolution {
 public:
  ...
  template <typename DataType>
  using DerivShift =
      ::Tags::deriv<gr::Tags::Shift<volume_dim, Frame::System, DataType>,
                    tmpl::size_t<volume_dim>, Frame::System>;
  template <typename DataType>
  using DerivSpatialMetric = ::Tags::deriv<
      gr::Tags::SpatialMetric<volume_dim, Frame::System, DataType>,
      tmpl::size_t<volume_dim>, Frame::System>;
  template <typename DataType>
  using tags = tmpl::list<
      gr::Tags::Lapse<DataType>, ::Tags::dt<gr::Tags::Lapse<DataType>>,
      DerivLapse<DataType>,
      gr::Tags::Shift<volume_dim, Frame::System, DataType>,
      ::Tags::dt<gr::Tags::Shift<volume_dim, Frame::System, DataType>>,
      DerivShift<DataType>,
      gr::Tags::SpatialMetric<volume_dim, Frame::System, DataType>,
      ::Tags::dt<gr::Tags::SpatialMetric<volume_dim, Frame::System, DataType>>,
      DerivSpatialMetric<DataType>, gr::Tags::SqrtDetSpatialMetric<DataType>,
      gr::Tags::ExtrinsicCurvature<volume_dim, Frame::System, DataType>,
      gr::Tags::InverseSpatialMetric<volume_dim, Frame::System, DataType>>;
