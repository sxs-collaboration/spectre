...
tuples::TaggedTuple<::Tags::Initial<
    Xcts::Tags::ConformalFactorGradient<3, Frame::System, DataType>>>
ConstantDensityStar::variables(
    const tnsr::I<DataType, 3, Frame::System>& x,
    tmpl::list<::Tags::Initial<Xcts::Tags::ConformalFactorGradient<
        3, Frame::System, DataType>>> /*meta*/) const noexcept {
  return {make_with_value<tnsr::I<DataType, 3, Frame::System>>(x, 0.)};
}
...
#define INSTANTIATE(_, data)                                                 \
  ...
  ConstantDensityStar::variables(                                            \
      const tnsr::I<DTYPE(data), 3, Frame::System>&,                         \
  ...
  template tuples::TaggedTuple<::Tags::Initial<                              \
      Xcts::Tags::ConformalFactorGradient<3, Frame::System, DTYPE(data)>>>   \
  ConstantDensityStar::variables(                                            \
      const tnsr::I<DTYPE(data), 3, Frame::System>&,                         \
      tmpl::list<::Tags::Initial<Xcts::Tags::ConformalFactorGradient<        \
          3, Frame::System, DTYPE(data)>>>) const noexcept;                  \
  template tuples::TaggedTuple<                                              \
