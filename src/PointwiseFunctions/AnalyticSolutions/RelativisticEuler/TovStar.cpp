...
TovStar<RadialSolution>::variables(
    ...
    tmpl::list<typename TovStar<RadialSolution>::template DerivLapse<
        DataType>> /*meta*/,
    const RadialVariables<DataType>& radial_vars) const noexcept {
  tnsr::i<DataType, 3, Frame::System> d_lapse{
...
template <typename RadialSolution>
template <typename DataType>
tuples::TaggedTuple<gr::Tags::Shift<3, Frame::System, DataType>>
TovStar<RadialSolution>::variables(
    const tnsr::I<DataType, 3>& x,
    tmpl::list<gr::Tags::Shift<3, Frame::System, DataType>> /*meta*/,
    const RadialVariables<DataType>& /*radial_vars*/) const noexcept {
  return make_with_value<tnsr::I<DataType, 3>>(x, 0.0);
}
...
template <typename RadialSolution>
template <typename DataType>
tuples::TaggedTuple<gr::Tags::SpatialMetric<3, Frame::System, DataType>>
TovStar<RadialSolution>::variables(
    const tnsr::I<DataType, 3>& x,
    tmpl::list<gr::Tags::SpatialMetric<3, Frame::System, DataType>> /*meta*/,
    const RadialVariables<DataType>& radial_vars) const noexcept {
  tnsr::ii<DataType, 3, Frame::System> spatial_metric{
...
TovStar<RadialSolution>::variables(
    ...
    tmpl::list<typename TovStar<RadialSolution>::template DerivSpatialMetric<
        DataType>> /*meta*/,
    const RadialVariables<DataType>& radial_vars) const noexcept {
  tnsr::ijj<DataType, 3, Frame::System> deriv_spatial_metric{
      2.0 *
      (exp(2.0 * radial_vars.metric_radial_potential) *
...
template <typename RadialSolution>
template <typename DataType>
tuples::TaggedTuple<gr::Tags::InverseSpatialMetric<3, Frame::System, DataType>>
TovStar<RadialSolution>::variables(
    const tnsr::I<DataType, 3>& x,
    tmpl::list<
        gr::Tags::InverseSpatialMetric<3, Frame::System, DataType>> /*meta*/,
    const RadialVariables<DataType>& radial_vars) const noexcept {
  tnsr::II<DataType, 3, Frame::System> g{
      exp(-2.0 * radial_vars.metric_radial_potential) -
      exp(-2.0 * radial_vars.metric_angular_potential)};
...
template <typename RadialSolution>
template <typename DataType>
tuples::TaggedTuple<gr::Tags::ExtrinsicCurvature<3, Frame::System, DataType>>
TovStar<RadialSolution>::variables(
    const tnsr::I<DataType, 3>& x,
    tmpl::list<
        gr::Tags::ExtrinsicCurvature<3, Frame::System, DataType>> /*meta*/,
    const RadialVariables<DataType>& /*radial_vars*/) const noexcept {
...
#define INSTANTIATE_VARS(_, data)                                              \
  ...
  TovStar<STYPE(data)>::variables(                                             \
      ...
      tmpl::list<typename TovStar<STYPE(data)>::template DerivLapse<DTYPE(     \
          data)>> /*meta*/,                                                    \
      const RadialVariables<DTYPE(data)>& radial_vars) const noexcept;         \
  template tuples::TaggedTuple<gr::Tags::Shift<3, Frame::System, DTYPE(data)>> \
  TovStar<STYPE(data)>::variables(                                             \
      const tnsr::I<DTYPE(data), 3>& /*x*/,                                    \
      tmpl::list<gr::Tags::Shift<3, Frame::System, DTYPE(data)>> /*meta*/,     \
      const RadialVariables<DTYPE(data)>& radial_vars) const noexcept;         \
  template tuples::TaggedTuple<                                                \
  ...
  TovStar<STYPE(data)>::variables(                                             \
      ...
      const RadialVariables<DTYPE(data)>& radial_vars) const noexcept;         \
  template tuples::TaggedTuple<                                                \
      gr::Tags::SpatialMetric<3, Frame::System, DTYPE(data)>>                  \
  TovStar<STYPE(data)>::variables(                                             \
      const tnsr::I<DTYPE(data), 3>& /*x*/,                                    \
      tmpl::list<                                                              \
          gr::Tags::SpatialMetric<3, Frame::System, DTYPE(data)>> /*meta*/,    \
      const RadialVariables<DTYPE(data)>& radial_vars) const noexcept;         \
  template tuples::TaggedTuple<                                                \
  ...
  TovStar<STYPE(data)>::variables(                                             \
      ...
      const RadialVariables<DTYPE(data)>& radial_vars) const noexcept;         \
  template tuples::TaggedTuple<                                                \
      gr::Tags::InverseSpatialMetric<3, Frame::System, DTYPE(data)>>           \
  TovStar<STYPE(data)>::variables(                                             \
      const tnsr::I<DTYPE(data), 3>& /*x*/,                                    \
      ...
      const RadialVariables<DTYPE(data)>& radial_vars) const noexcept;         \
  template tuples::TaggedTuple<                                                \
      gr::Tags::ExtrinsicCurvature<3, Frame::System, DTYPE(data)>>             \
  TovStar<STYPE(data)>::variables(                                             \
      const tnsr::I<DTYPE(data), 3>& /*x*/,                                    \
      tmpl::list<gr::Tags::ExtrinsicCurvature<3, Frame::System,                \
                                              DTYPE(data)>> /*meta*/,          \
      const RadialVariables<DTYPE(data)>& radial_vars) const noexcept;
