...
RiemannProblem::RiemannProblem(CkMigrateMessage* /*unused*/) noexcept {}

void RiemannProblem::pup(PUP::er& p) noexcept {
...
bool operator==(const RiemannProblem& lhs, const RiemannProblem& rhs) noexcept {
...
RiemannProblem::variables(
    ...
    tmpl::list<gr::Tags::Shift<3, Frame::Inertial, double>> /*meta*/)
    const noexcept;
