 ...
 * \cite Beckwith2011).  It describes the flow of an ideal fluid with
 ...
 * paper](https://arxiv.org/abs/1609.00098) \cite Kidder2017 and there
 * is a sign error in the velocity in
 * [arXiv:1101.3573](https://arxiv.org/abs/1101.3573)
 * \cite Beckwith2011.  Despite these errors, the actual tests
