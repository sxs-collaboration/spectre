...
class TestVolumeData(unittest.TestCase):
    ...
    def setUp(self):
        ...
        grid_names = ["[B0(L1I0,L1I0,L1I0)]", "[B0(L1I0,L1I0,L1I1)]"]
    ...
    def test_grids(self):
        ...
        expected_grid_names = ["[B0(L1I0,L1I0,L1I0)]", "[B0(L1I0,L1I0,L1I1)]"]
    ...
    def test_get_data_by_element(self):
        ...
        self.assertEqual(
            volume_data[0][2][0].element_name, "[B0(L1I0,L1I0,L1I0)]"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            volume_data[0][2][1].element_name, "[B0(L1I0,L1I0,L1I1)]"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            volume_data[1][2][0].element_name, "[B0(L1I0,L1I0,L1I0)]"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            volume_data[1][2][1].element_name, "[B0(L1I0,L1I0,L1I1)]"
        )
        self.assertEqual(
