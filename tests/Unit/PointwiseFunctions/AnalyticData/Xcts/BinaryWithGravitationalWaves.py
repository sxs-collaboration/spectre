...
def deriv_one_over_distance_left(x):
    minus_x = np.array([x[0] - 0.0001, x[1], x[2]])
    minus_middle_x = np.array([x[0] - 0.00005, x[1], x[2]])
    minus_y = np.array([x[0], x[1] - 0.0001, x[2]])
    minus_middle_y = np.array([x[0], x[1] - 0.00005, x[2]])
    minus_z = np.array([x[0], x[1], x[2] - 0.0001])
    minus_middle_z = np.array([x[0], x[1], x[2] - 0.00005])
    plus_x = np.array([x[0] + 0.0001, x[1], x[2]])
    plus_middle_x = np.array([x[0] + 0.00005, x[1], x[2]])
    plus_y = np.array([x[0], x[1] + 0.0001, x[2]])
    plus_middle_y = np.array([x[0], x[1] + 0.00005, x[2]])
    plus_z = np.array([x[0], x[1], x[2] + 0.0001])
    plus_middle_z = np.array([x[0], x[1], x[2] + 0.00005])

    deriv_one_over_distance_left_aux = np.zeros(3)
    deriv_one_over_distance_left_aux[0] = (
        1.0 / distance_left(minus_x)
        - 8 * 1.0 / distance_left(minus_middle_x)
        + 8 * 1.0 / distance_left(plus_middle_x)
        - 1.0 / distance_left(plus_x)
    ) / (12 * 0.00005)
    deriv_one_over_distance_left_aux[1] = (
        1.0 / distance_left(minus_y)
        - 8 * 1.0 / distance_left(minus_middle_y)
        + 8 * 1.0 / distance_left(plus_middle_y)
        - 1.0 / distance_left(plus_y)
    ) / (12 * 0.00005)
    deriv_one_over_distance_left_aux[2] = (
        1.0 / distance_left(minus_z)
        - 8 * 1.0 / distance_left(minus_middle_z)
        + 8 * 1.0 / distance_left(plus_middle_z)
        - 1.0 / distance_left(plus_z)
    ) / (12 * 0.00005)
    return deriv_one_over_distance_left_aux
...
def deriv_one_over_distance_right(x):
    ...
    deriv_one_over_distance_right_aux = np.zeros(3)
    deriv_one_over_distance_right_aux[0] = (
        1.0 / distance_right(minus_x)
        - 8 * 1.0 / distance_right(minus_middle_x)
        + 8 * 1.0 / distance_right(plus_middle_x)
        - 1.0 / distance_right(plus_x)
    ) / (12 * 0.00005)
    deriv_one_over_distance_right_aux[1] = (
        1.0 / distance_right(minus_y)
        - 8 * 1.0 / distance_right(minus_middle_y)
        + 8 * 1.0 / distance_right(plus_middle_y)
        - 1.0 / distance_right(plus_y)
    ) / (12 * 0.00005)
    deriv_one_over_distance_right_aux[2] = (
        1.0 / distance_right(minus_z)
        - 8 * 1.0 / distance_right(minus_middle_z)
        + 8 * 1.0 / distance_right(plus_middle_z)
        - 1.0 / distance_right(plus_z)
    ) / (12 * 0.00005)
    return deriv_one_over_distance_right_aux
