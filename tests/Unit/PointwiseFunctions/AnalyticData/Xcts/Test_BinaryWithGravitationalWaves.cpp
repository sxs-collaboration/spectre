...
void test_data(const double mass_left, const double mass_right,
  ...
  Affine>;
    ...
    const std::array<double, 3> lower_bound{{20.831, 5.241, 3.391}};
    const std::array<double, 3> upper_bound{{20.836, 5.246, 3.396}};
  ...
  Frame::Inertial>(Affine3D{ Affine{-1., 1., lower_bound[0], upper_bound[0]},
    ...
    const auto deriv_1_distance_right = partial_derivative(distance_right, mesh,
  inv_jacobian); const auto deriv_1_distance_left =
  partial_derivative(distance_left, mesh, inv_jacobian); const auto
  deriv_2_distance_right = partial_derivative(deriv_1_distance_right, mesh,
  inv_jacobian); const auto deriv_2_distance_left =
  partial_derivative(deriv_1_distance_left, mesh, inv_jacobian); const auto
  deriv_3_distance_right_test = partial_derivative(deriv_2_distance_right, mesh,
  inv_jacobian); const auto deriv_3_distance_left_test =
  partial_derivative(deriv_2_distance_left, mesh, inv_jacobian); const auto
  deriv_3_distance_variables = binary.variables(x, mesh, inv_jacobian,
  tmpl::list<
    ::Tags::deriv<
        ::Tags::deriv<
    ...
    const auto deriv_3_distance_right = get<::Tags::deriv<
        ::Tags::deriv<
            ::Tags::deriv<detail::Tags::DistanceRight<DataVector>,
                          tmpl::size_t<3>, Frame::Inertial>,
            tmpl::size_t<3>, Frame::Inertial>,
        tmpl::size_t<3>, Frame::Inertial>>(deriv_3_distance_variables);
    ...
    CHECK_ITERABLE_APPROX(deriv_3_distance_right_test, deriv_3_distance_right);
    CHECK_ITERABLE_APPROX(deriv_3_distance_left_test, deriv_3_distance_left);
  }*/
  {
