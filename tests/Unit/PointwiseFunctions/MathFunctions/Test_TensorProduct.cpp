...
struct Var2 : db::SimpleTag {
  using type = tnsr::i<DataVector, VolumeDim, Frame::Physical>;
...
void test_with_numerical_derivatives(
  ...
  const auto& dVar1 =
      get<Tags::deriv<Var1, tmpl::size_t<VolumeDim>, Frame::Physical>>(du);
  ...
  const auto& dVar2 = get<
      Tags::deriv<Var2<VolumeDim>, tmpl::size_t<VolumeDim>, Frame::Physical>>(
      du);
