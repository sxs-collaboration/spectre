...
struct SmoothFlowProxy : RelativisticEuler::Solutions::SmoothFlow<Dim> {
  ...
  using variables_tags =
      tmpl::list<hydro::Tags::RestMassDensity<DataType>,
                 hydro::Tags::SpatialVelocity<DataType, Dim, Frame::System>,
...
void test_solution(const DataType& used_for_size,
  ...
  CHECK_ITERABLE_APPROX(
      ...
      get<gr::Tags::Lapse<DataType>>(solution.variables(
          coords, dummy_time, tmpl::list<gr::Tags::Lapse<DataType>>{})));
  CHECK_ITERABLE_APPROX(
      (get<gr::Tags::Shift<Dim, Frame::System, DataType>>(minkowski.variables(
          coords, dummy_time,
          tmpl::list<gr::Tags::Shift<Dim, Frame::System, DataType>>{}))),
      (get<gr::Tags::Shift<Dim, Frame::System, DataType>>(solution.variables(
          coords, dummy_time,
          tmpl::list<gr::Tags::Shift<Dim, Frame::System, DataType>>{}))));
  CHECK_ITERABLE_APPROX(
      (get<gr::Tags::SpatialMetric<Dim, Frame::System, DataType>>(
          minkowski.variables(
              coords, dummy_time,
              tmpl::list<
