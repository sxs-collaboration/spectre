...
void test_strahlkorper_from_other_strahlkorper() {
  ...
  Strahlkorper<Frame::Grid> grid_strahlkorper{
  ...
  Strahlkorper<Frame::Inertial> inertial_strahlkorper_copy =
      inertial_strahlkorper;
  grid_strahlkorper =
      Strahlkorper<Frame::Grid>(inertial_strahlkorper.coefficients(),
                                std::move(inertial_strahlkorper_copy));

  // Can't use the copied one because we moved it into the grid strahlkorper
  check_equal(inertial_strahlkorper, grid_strahlkorper);
