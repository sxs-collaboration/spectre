...
SPECTRE_TEST_CASE("Unit.DataStructures.Tensor.EagerMath.EuclideanDotProduct",
  ...
  // Check for DataVectors
  {
    ...
    const tnsr::i<DataVector, 1, Frame::GlobalTimeIndependent> one_d_covector_a{
        {{two}}};
    const tnsr::i<DataVector, 1, Frame::GlobalTimeIndependent> one_d_covector_b{
        {{four}}};
    const tnsr::I<DataVector, 1, Frame::GlobalTimeIndependent> one_d_vector_c{
        {{four}}};
    ...
    const tnsr::A<DataVector, 1, Frame::GlobalTimeIndependent> one_d_vector_a{
        {{minus_three, four}}};
    const tnsr::A<DataVector, 1, Frame::GlobalTimeIndependent> one_d_vector_b{
        {{two, twelve}}};
    const tnsr::a<DataVector, 1, Frame::GlobalTimeIndependent> one_d_covector_c{
        {{two, twelve}}};
    ...
    const tnsr::I<DataVector, 2, Frame::GlobalTimeIndependent> two_d_vector_a{
        {{minus_five, twelve}}};
    const tnsr::I<DataVector, 2, Frame::GlobalTimeIndependent> two_d_vector_b{
        {{two, four}}};
    const tnsr::i<DataVector, 2, Frame::GlobalTimeIndependent> two_d_covector_b{
        {{two, four}}};
    ...
    const tnsr::i<DataVector, 3, Frame::GlobalTimeIndependent>
        three_d_covector_a{{{minus_three, twelve, four}}};
    const tnsr::i<DataVector, 3, Frame::GlobalTimeIndependent>
        three_d_covector_b{{{four, minus_five, two}}};
    const tnsr::I<DataVector, 3, Frame::GlobalTimeIndependent> three_d_vector_b{
        {{four, minus_five, two}}};
    CHECK_ITERABLE_APPROX(
    ...
    // 5D example
    const tnsr::a<DataVector, 4, Frame::GlobalTimeIndependent>
        five_d_covector_a{{{two, twelve, four, one, two}}};
    const tnsr::a<DataVector, 4, Frame::GlobalTimeIndependent>
        five_d_covector_b{{{minus_five, minus_three, two, four, one}}};
    const tnsr::A<DataVector, 4, Frame::GlobalTimeIndependent> five_d_vector_b{
  ...
  // Check case for doubles
  {
    ...
    const tnsr::A<double, 4, Frame::GlobalTimeIndependent>
        five_d_vector_double_b{{{4.0, 2.0, -4.0, 3.0, 5.0}}};
...
SPECTRE_TEST_CASE("Unit.DataStructures.Tensor.EagerMath.DotProduct",
  ...
  // Check for DataVectors
  {
    ...
    const tnsr::i<DataVector, 3, Frame::GlobalTimeIndependent>
        three_d_covector_a{{{minus_three, twelve, four}}};
    const tnsr::i<DataVector, 3, Frame::GlobalTimeIndependent>
        three_d_covector_b{{{minus_five, four, two}}};
  ...
  {
    // Check for doubles
    const tnsr::i<double, 1, Frame::GlobalTimeIndependent> one_d_covector_a{
        2.0};
    const tnsr::i<double, 1, Frame::GlobalTimeIndependent> one_d_covector_b{
        4.0};
    ...
    const tnsr::i<double, 3, Frame::GlobalTimeIndependent> three_d_covector_a{
        {{-3.0, 12.0, 4.0}}};
    const tnsr::i<double, 3, Frame::GlobalTimeIndependent> three_d_covector_b{
        {{-5.0, 4.0, 2.0}}};
