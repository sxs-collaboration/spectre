...
void test_data_vector_math() noexcept {
  ...
  TestHelpers::VectorImpl::Bound positive{{0.01, 100.0}};
  auto unary_ops = std::make_tuple(
  ...
  TestHelpers::VectorImpl::VectorTestFunctors<
      TestHelpers::VectorImpl::TestType::Normal, DataVector>{}(binary_ops);

  auto inplace_binary_ops = std::make_tuple(
  ...
  TestHelpers::VectorImpl::VectorTestFunctors<
      TestHelpers::VectorImpl::TestType::Inplace, DataVector>{}(
      inplace_binary_ops);

  auto strict_binary_ops = std::make_tuple(
      std::make_tuple(funcl::Atan2<>{}, std::make_tuple(generic, positive)),
      std::make_tuple(funcl::Hypot<>{}, std::make_tuple(generic, positive)));

  TestHelpers::VectorImpl::VectorTestFunctors<
      TestHelpers::VectorImpl::TestType::Strict, DataVector>{}(
      strict_binary_ops);

  auto cascaded_ops = std::make_tuple(
  ...
  TestHelpers::VectorImpl::VectorTestFunctors<
      TestHelpers::VectorImpl::TestType::Strict, DataVector>{}(cascaded_ops);

  auto array_binary_ops = std::make_tuple(
      std::make_tuple(funcl::Minus<>{}, std::make_tuple(generic, generic)),
      std::make_tuple(funcl::Plus<>{}, std::make_tuple(generic, generic)));
