...
// to value type of [-100,100]. The second vector type should be constructable
...
void test_check_vectors(const FundValType1& low1 = FundValType1{-100},
  ...
  TestHelpers::VectorImpl::check_vectors(t1, t2);
  TestHelpers::VectorImpl::check_vectors(t1, v2);
  TestHelpers::VectorImpl::check_vectors(v1, t2);
  TestHelpers::VectorImpl::check_vectors(v1, v2);
  // check arrays with arrays
  TestHelpers::VectorImpl::check_vectors(a1_1, a1_2);
  TestHelpers::VectorImpl::check_vectors(a2_1, a2_2);
  // check arrays with vectors or values
  TestHelpers::VectorImpl::check_vectors(a1_1, t2);
  TestHelpers::VectorImpl::check_vectors(a1_1, v2);
  TestHelpers::VectorImpl::check_vectors(t1, a1_2);
  TestHelpers::VectorImpl::check_vectors(v2, a1_2);
}
