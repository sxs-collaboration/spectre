...
void test_has_potential_sibling() {
  ...
  CHECK_FALSE(domain::amr::has_potential_sibling(element_id_1d,
  ...
  CHECK_FALSE(domain::amr::has_potential_sibling(element_id_2d,
  ...
  CHECK_FALSE(domain::amr::has_potential_sibling(element_id_3d,
