...
void test_1d() {
  ...
  check_if_maps_are_equal(
      ...
      make_coordinate_map<Frame::ElementLogical, Frame::Grid>(identity_map1d));
  check_if_maps_are_equal(
      make_coordinate_map<Frame::ElementLogical, Frame::Grid>(
          CoordinateMaps::Affine{-1.0, 1.0, 1.0, -1.0}),
      make_coordinate_map<Frame::ElementLogical, Frame::Grid>(rotation_nx));
...
void test_2d() {
  ...
  check_if_maps_are_equal(
      ...
      make_coordinate_map<Frame::ElementLogical, Frame::Grid>(identity_map2d));
  check_if_maps_are_equal(
      make_coordinate_map<Frame::ElementLogical, Frame::Grid>(
          CoordinateMaps::Rotation<2>{M_PI_2}),
      make_coordinate_map<Frame::ElementLogical, Frame::Grid>(rotation_ny_px));
...
void test_3d() {
  ...
  check_if_maps_are_equal(
      make_coordinate_map<Frame::ElementLogical, Frame::Grid>(id3d),
      make_coordinate_map<Frame::ElementLogical, Frame::Grid>(identity_map3d));
  check_if_maps_are_equal(
      make_coordinate_map<Frame::ElementLogical, Frame::Grid>(
