...
class TestFunctionsOfTime(unittest.TestCase):
    def test_deserialize(self):
        ...
        self.assertEqual(translation.time_bounds(), [0., math.inf])
        self.assertEqual(translation.func(0.), [DataVector(size=3, fill=0.)])
        self.assertEqual(translation.func_and_deriv(0.),
                         2 * [DataVector(size=3, fill=0.)])
        self.assertEqual(translation.func_and_2_derivs(0.),
                         3 * [DataVector(size=3, fill=0.)])
