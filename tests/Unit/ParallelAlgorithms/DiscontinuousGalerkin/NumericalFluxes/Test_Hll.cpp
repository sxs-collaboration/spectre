...
#include "ParallelAlgorithms/DiscontinuousGalerkin/NumericalFluxes/Hll.hpp"
#include "Utilities/Gsl.hpp"
#include "Utilities/TMPL.hpp"
#include "tests/Unit/ParallelAlgorithms/DiscontinuousGalerkin/NumericalFluxes/TestHelpers.hpp"
...
void apply_hll_flux(
  ...
  Variables<typename hll_flux::package_tags> packaged_data_interior(
  ...
  Variables<typename hll_flux::package_tags> packaged_data_exterior(
      n_dot_f_1_int.begin()->size(),
      std::numeric_limits<double>::signaling_NaN());
  flux_computer.package_data(
...
SPECTRE_TEST_CASE("Unit.DiscontinuousGalerkin.Fluxes.Hll",
  ...
  pypp::SetupLocalPythonEnvironment local_python_env{
      "ParallelAlgorithms/DiscontinuousGalerkin/NumericalFluxes"};
