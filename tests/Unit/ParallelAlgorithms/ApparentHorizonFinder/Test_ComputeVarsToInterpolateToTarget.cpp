...
void test_compute_horizon_volume_quantities(const bool is_time_dependent) {
  ...
  if (is_time_dependent) {
    ...
    // QUESTION: Did I implement this correctly? Left the loop below just in
    // case
