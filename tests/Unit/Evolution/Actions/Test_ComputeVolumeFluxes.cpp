...
struct Var2 : db::SimpleTag {
  ...
  using type = tnsr::I<double, dim, Frame::System>;
};

using flux_tag = Tags::Flux<Var1, tmpl::size_t<dim>, Frame::System>;

struct ComputeFluxes {
  using argument_tags = tmpl::list<Var2, Var1>;
  using return_tags = tmpl::list<flux_tag>;
  static void apply(
      const gsl::not_null<tnsr::I<double, dim, Frame::System>*> flux1,
      const tnsr::I<double, dim, Frame::System>& var2,
