...
void test_impl(const std::vector<double>& expected_values,
  ...
  CHECK(SubcellOptions(
            ...
            false, ::fd::DerivativeOrder::Two, 1, 1, 1) !=
  ...
  CHECK_FALSE(SubcellOptions(
                  ...
                  recons_method, false, ::fd::DerivativeOrder::Two, 1, 1, 1) ==
              SubcellOptions(values[0], static_cast<size_t>(values[1]),
                             values[2], values[3], false, false, recons_method,
                             false, ::fd::DerivativeOrder::Two, 1, 1, 1));
  ...
  CHECK_FALSE(SubcellOptions(
              ...
              SubcellOptions(
                  expected_values[0], static_cast<size_t>(expected_values[1]),
                  expected_values[2], expected_values[3], true, false,
                  recons_method, false, ::fd::DerivativeOrder::Two, 1, 1, 1));

  CHECK(SubcellOptions(
            expected_values[0], static_cast<size_t>(expected_values[1]),
            expected_values[2], expected_values[3], false, false, recons_method,
            false, ::fd::DerivativeOrder::Two, 1, 1,
            1) != SubcellOptions(expected_values[0],
  ...
  CHECK_FALSE(SubcellOptions(
              ...
              SubcellOptions(
                  expected_values[0], static_cast<size_t>(expected_values[1]),
                  expected_values[2], expected_values[3], false, false,
                  recons_method, true, ::fd::DerivativeOrder::Two, 1, 1, 1));
  CHECK_FALSE(SubcellOptions(
                  expected_values[0], static_cast<size_t>(expected_values[1]),
                  expected_values[2], expected_values[3], false, false,
                  recons_method, false, ::fd::DerivativeOrder::Four, 1, 1, 1) ==
              SubcellOptions(
                  expected_values[0], static_cast<size_t>(expected_values[1]),
                  expected_values[2], expected_values[3], false, false,
                  recons_method, false, ::fd::DerivativeOrder::Two, 1, 1, 1));
  CHECK_FALSE(SubcellOptions(
                  expected_values[0], static_cast<size_t>(expected_values[1]),
                  expected_values[2], expected_values[3], false, false,
                  recons_method, false, ::fd::DerivativeOrder::Two, 2, 1, 1) ==
              SubcellOptions(
                  expected_values[0], static_cast<size_t>(expected_values[1]),
                  expected_values[2], expected_values[3], false, false,
                  recons_method, false, ::fd::DerivativeOrder::Two, 1, 1, 1));
  CHECK_FALSE(SubcellOptions(
                  expected_values[0], static_cast<size_t>(expected_values[1]),
                  expected_values[2], expected_values[3], false, false,
                  recons_method, false, ::fd::DerivativeOrder::Two, 1, 2, 1) ==
              SubcellOptions(
                  expected_values[0], static_cast<size_t>(expected_values[1]),
                  expected_values[2], expected_values[3], false, false,
                  recons_method, false, ::fd::DerivativeOrder::Two, 1, 1, 1));
  CHECK_FALSE(SubcellOptions(
                  expected_values[0], static_cast<size_t>(expected_values[1]),
                  expected_values[2], expected_values[3], false, false,
                  recons_method, false, ::fd::DerivativeOrder::Two, 1, 1, 2) ==
              SubcellOptions(
                  expected_values[0], static_cast<size_t>(expected_values[1]),
                  expected_values[2], expected_values[3], false, false,
                  recons_method, false, ::fd::DerivativeOrder::Two, 1, 1, 1));
