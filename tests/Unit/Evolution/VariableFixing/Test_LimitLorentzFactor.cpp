...
void test_variable_fixer(const LimitLorentzFactor& variable_fixer) {
  ...
  auto spatial_metric =
      make_with_value<tnsr::ii<DataVector, 3, Frame::Physical>>(density, 1.0);
  ...
  tnsr::I<DataVector, 3, Frame::Physical> spatial_velocity{
  ...
  const tnsr::I<DataVector, 3, Frame::Physical> expected_spatial_velocity{
