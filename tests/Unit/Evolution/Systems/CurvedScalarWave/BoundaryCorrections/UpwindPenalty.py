...
def dg_package_data_char_speeds(
    ...
    result = np.zeros([4])
    result[0] = char_speed_vpsi(
        constraint_gamma1, lapse, shift, interface_unit_normal
    )
    result[1] = char_speed_vzero(
        constraint_gamma1, lapse, shift, interface_unit_normal
    )
    result[2] = char_speed_vplus(
        constraint_gamma1, lapse, shift, interface_unit_normal
    )
    result[3] = char_speed_vminus(
        constraint_gamma1, lapse, shift, interface_unit_normal
    )
