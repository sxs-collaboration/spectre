...
def soln_tilde_e(face_mesh_velocity, outward_directed_normal_covector,
                 outward_directed_normal_vector, coords, time, dim,
                 parallel_conductivity):
...
def soln_tilde_psi(face_mesh_velocity, outward_directed_normal_covector,
                   outward_directed_normal_vector, coords, time, dim,
                   parallel_conductivity):
...
def soln_tilde_q(face_mesh_velocity, outward_directed_normal_covector,
                 outward_directed_normal_vector, coords, time, dim,
                 parallel_conductivity):
    return fastwave.TildeQ(coords, time)


def soln_flux_tilde_e(face_mesh_velocity, outward_directed_normal_covector,
                      outward_directed_normal_vector, coords, time, dim,
                      parallel_conductivity):
    ...
    return fluxes.tilde_e_flux(
        ...
        current.tilde_j(tilde_q, tilde_e, tilde_b, parallel_conductivity,
                        lapse, sqrt_det_spatial_metric, spatial_metric), lapse,
...
def soln_flux_tilde_psi(face_mesh_velocity, outward_directed_normal_covector,
                        outward_directed_normal_vector, coords, time, dim,
                        parallel_conductivity):
    tilde_e = fastwave.TildeE(coords, time)
    tilde_b = fastwave.TildeB(coords, time)
...
def soln_flux_tilde_q(face_mesh_velocity, outward_directed_normal_covector,
                      outward_directed_normal_vector, coords, time, dim,
                      parallel_conductivity):
    tilde_e = fastwave.TildeE(coords, time)
    tilde_b = fastwave.TildeB(coords, time)
...
def data_tilde_e(face_mesh_velocity, outward_directed_normal_covector,
                 outward_directed_normal_vector, coords, time, dim,
                 parallel_conductivity):
...
def data_tilde_psi(face_mesh_velocity, outward_directed_normal_covector,
                   outward_directed_normal_vector, coords, time, dim,
                   parallel_conductivity):
...
def data_tilde_q(face_mesh_velocity, outward_directed_normal_covector,
                 outward_directed_normal_vector, coords, time, dim,
                 parallel_conductivity):
    return breakdown.TildeQ(coords)


def data_flux_tilde_e(face_mesh_velocity, outward_directed_normal_covector,
                      outward_directed_normal_vector, coords, time, dim,
                      parallel_conductivity):
...
def data_flux_tilde_psi(face_mesh_velocity, outward_directed_normal_covector,
                        outward_directed_normal_vector, coords, time, dim,
                        parallel_conductivity):
    tilde_e = breakdown.TildeE(coords)
    tilde_b = breakdown.TildeB(coords)
...
def data_flux_tilde_q(face_mesh_velocity, outward_directed_normal_covector,
                      outward_directed_normal_vector, coords, time, dim,
                      parallel_conductivity):
    tilde_e = breakdown.TildeE(coords)
    tilde_b = breakdown.TildeB(coords)
