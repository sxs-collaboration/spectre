...
SPECTRE_TEST_CASE("Unit.RadiationTransport.M1Grey.Actions", "[Unit][M1Grey]") {
  ...
  ActionTesting::emplace_component_and_initialize<component>(
      ...
      {Scalar<DataVector>{xi}, Scalar<DataVector>{xi}, tildeP, tildeP,
       ...
       tnsr::i<DataVector, 3, Frame::Physical>{{{Hx, Hy, Hz}}},
       tnsr::i<DataVector, 3, Frame::Physical>{{{Hx, Hy, Hz}}},
       Scalar<DataVector>{E0}, Scalar<DataVector>{E1},
       tnsr::i<DataVector, 3, Frame::Physical>{{{Sx0, Sy0, Sz0}}},
       tnsr::i<DataVector, 3, Frame::Physical>{{{Sx1, Sy1, Sz1}}},
       tnsr::I<DataVector, 3, Frame::Physical>{{{vx, vy, vz}}},
       Scalar<DataVector>{W}, metric, inverse_metric,
       tnsr::I<DataVector, 3, Frame::Physical>{{{x, y, z}}}});
