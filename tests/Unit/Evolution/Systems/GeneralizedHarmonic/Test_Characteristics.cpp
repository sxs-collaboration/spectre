...
void test_characteristic_speeds_analytic(
  ...
  auto unit_normal_one_form =
      make_with_value<tnsr::i<DataVector, spatial_dim, Frame::Physical>>(x, 1.);
  ...
  const auto char_speeds_from_func =
      GeneralizedHarmonic::CharacteristicSpeedsCompute<
          spatial_dim, Frame::Physical>::function(gamma_1, lapse, shift,
...
void test_characteristic_fields_analytic(
  ...
  const auto normal_one_form =
      gr::spacetime_normal_one_form<spatial_dim, Frame::Physical>(lapse);
  ...
  tnsr::aa<DataVector, spatial_dim, Frame::Physical> phi_dot_normal{
      DataVector(n_pts, 0.)};
  ...
  tnsr::iaa<DataVector, spatial_dim, Frame::Physical> phi_dot_projection_tensor{
      DataVector(n_pts, 0.)};
  ...
  tnsr::aa<DataVector, spatial_dim, Frame::Physical> uplus{
      DataVector(n_pts, 0.)};
  tnsr::aa<DataVector, spatial_dim, Frame::Physical> uminus{
      DataVector(n_pts, 0.)};
  for (size_t mu = 0; mu < spatial_dim + 1; ++mu) {
    for (size_t nu = 0; nu < mu + 1; ++nu) {
  ...
  const auto uvars = GeneralizedHarmonic::CharacteristicFieldsCompute<
      spatial_dim, Frame::Physical>::function(gamma_2, inverse_spatial_metric,
                                              spacetime_metric, pi, phi,
                                              unit_normal_one_form);

  const auto& upsi_from_func =
      get<GeneralizedHarmonic::Tags::UPsi<spatial_dim, Frame::Physical>>(uvars);
  const auto& uzero_from_func =
      get<GeneralizedHarmonic::Tags::UZero<spatial_dim, Frame::Physical>>(
          uvars);
  const auto& uplus_from_func =
      get<GeneralizedHarmonic::Tags::UPlus<spatial_dim, Frame::Physical>>(
          uvars);
  const auto& uminus_from_func =
      get<GeneralizedHarmonic::Tags::UMinus<spatial_dim, Frame::Physical>>(
          uvars);
...
void test_evolved_from_characteristic_fields_analytic(
  ...
  const auto ffields =
      GeneralizedHarmonic::EvolvedFieldsFromCharacteristicFieldsCompute<
          spatial_dim, Frame::Physical>::function(gamma_2, upsi, uzero, uplus,
                                                  uminus, unit_normal_one_form);
  const auto& psi_from_func =
      get<gr::Tags::SpacetimeMetric<spatial_dim, Frame::Physical>>(ffields);
  const auto& pi_from_func =
      get<GeneralizedHarmonic::Tags::Pi<spatial_dim, Frame::Physical>>(ffields);
  const auto& phi_from_func =
      get<GeneralizedHarmonic::Tags::Phi<spatial_dim, Frame::Physical>>(
          ffields);
...
SPECTRE_TEST_CASE("Unit.Evolution.Systems.GeneralizedHarmonic.MaxCharSpeed",
  ...
  CHECK(GeneralizedHarmonic::ComputeLargestCharacteristicSpeed<
            1, Frame::GlobalTimeIndependent>::apply({{DataVector{1., 4., 3., 2.,
                                                                 5.},
                                                      DataVector{2., 8., 10.,
                                                                 6., 4.},
                                                      DataVector{1., 7., 3., 2.,
  ...
  CHECK(GeneralizedHarmonic::ComputeLargestCharacteristicSpeed<
            2, Frame::GlobalTimeIndependent>::apply({{DataVector{1., 4., 3., 2.,
                                                                 5.},
                                                      DataVector{2., 8., 7., 6.,
                                                                 4.},
                                                      DataVector{1., 10., 3.,
                                                      ...
                                                      DataVector{7., 3., 4., 2.,
                                                                 1.}}}) == 10.);
  CHECK(GeneralizedHarmonic::ComputeLargestCharacteristicSpeed<
            2, Frame::GlobalTimeIndependent>::
            apply({{DataVector{1., 4., 3., 2., 5.},
                    DataVector{2., 8., 10., 6., 4.},
  ...
  CHECK(GeneralizedHarmonic::ComputeLargestCharacteristicSpeed<
            3, Frame::GlobalTimeIndependent>::apply({{DataVector{1., 4., 10.,
                                                                 2., 5.},
                                                      DataVector{2., 8., 3., 6.,
                                                                 4.},
                                                      DataVector{1., 7., 3., 2.,
  ...
  CHECK(GeneralizedHarmonic::ComputeLargestCharacteristicSpeed<
        ...
        10.);
  CHECK(GeneralizedHarmonic::ComputeLargestCharacteristicSpeed<
            3, Frame::Physical>::apply({{DataVector{1., 4., 3., 2., 5.},
                                         DataVector{2., 8., 10., 6., 4.},
                                         DataVector{1., 7., 3., 2., 5.},
