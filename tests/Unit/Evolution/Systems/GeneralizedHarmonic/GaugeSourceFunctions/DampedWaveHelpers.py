...
def spacetime_deriv_log_fac(
    ...
    d4N[1:] = d3N
    # if exponent == 0, the first term automatically vanishes
    d_logfac = (exponent / detg) * dg - (1.0 / lapse) * d4N
    return d_logfac


def spacetime_deriv_pow_log_fac(
    lapse,
    shift,
    spacetime_unit_normal,
    inverse_spatial_metric,
    ...
    dlogfac = spacetime_deriv_log_fac(
        lapse,
        shift,
        spacetime_unit_normal,
        inverse_spatial_metric,
