...
def tilde_ye_flux(tilde_d, tilde_ye, tilde_tau, tilde_s, tilde_b, tilde_phi,
                  ...
                  rest_mass_density, electron_fraction, specific_enthalpy,
                  extrinsic_curvature, constraint_damping_parameter):
    return Fluxes.tilde_ye_flux(tilde_d, tilde_ye, tilde_tau, tilde_s, tilde_b,
                                tilde_phi, lapse, shift,
                                sqrt_det_spatial_metric, spatial_metric,
                                inv_spatial_metric, pressure, spatial_velocity,
                                lorentz_factor, magnetic_field)
...
def tilde_tau_flux(tilde_d, tilde_ye, tilde_tau, tilde_s, tilde_b, tilde_phi,
                   ...
                   rest_mass_density, electron_fraction, specific_enthalpy,
                   extrinsic_curvature, constraint_damping_parameter):
    return Fluxes.tilde_tau_flux(tilde_d, tilde_ye, tilde_tau, tilde_s,
...
def tilde_s_flux(tilde_d, tilde_ye, tilde_tau, tilde_s, tilde_b, tilde_phi,
                 ...
                 rest_mass_density, electron_fraction, specific_enthalpy,
                 extrinsic_curvature, constraint_damping_parameter):
    return Fluxes.tilde_s_flux(tilde_d, tilde_ye, tilde_tau, tilde_s, tilde_b,
                               tilde_phi, lapse, shift,
                               sqrt_det_spatial_metric, spatial_metric,
                               inv_spatial_metric, pressure, spatial_velocity,
                               lorentz_factor, magnetic_field)
...
def tilde_b_flux(tilde_d, tilde_ye, tilde_tau, tilde_s, tilde_b, tilde_phi,
                 ...
                 rest_mass_density, electron_fraction, specific_enthalpy,
                 extrinsic_curvature, constraint_damping_parameter):
    return Fluxes.tilde_b_flux(tilde_d, tilde_ye, tilde_tau, tilde_s, tilde_b,
                               tilde_phi, lapse, shift,
                               sqrt_det_spatial_metric, spatial_metric,
                               inv_spatial_metric, pressure, spatial_velocity,
                               lorentz_factor, magnetic_field)
...
def tilde_phi_flux(tilde_d, tilde_ye, tilde_tau, tilde_s, tilde_b, tilde_phi,
                   ...
                   rest_mass_density, electron_fraction, specific_enthalpy,
                   extrinsic_curvature, constraint_damping_parameter):
    return Fluxes.tilde_phi_flux(tilde_d, tilde_ye, tilde_tau, tilde_s,
                                 tilde_b, tilde_phi, lapse, shift,
                                 sqrt_det_spatial_metric, spatial_metric,
                                 inv_spatial_metric, pressure,
                                 spatial_velocity, lorentz_factor,
...
def source_tilde_d(tilde_d, tilde_ye, tilde_tau, tilde_s, tilde_b, tilde_phi,
                   lapse, shift, sqrt_det_spatial_metric, spatial_metric,
                   inv_spatial_metric, d_lapse, d_shift, d_spatial_metric,
                   pressure, spatial_velocity, lorentz_factor, magnetic_field,
                   rest_mass_density, electron_fraction, specific_enthalpy,
...
def source_tilde_ye(tilde_d, tilde_ye, tilde_tau, tilde_s, tilde_b, tilde_phi,
                    lapse, shift, sqrt_det_spatial_metric, spatial_metric,
                    inv_spatial_metric, d_lapse, d_shift, d_spatial_metric,
                    pressure, spatial_velocity, lorentz_factor, magnetic_field,
                    rest_mass_density, electron_fraction, specific_enthalpy,
...
def source_tilde_tau(tilde_d, tilde_ye, tilde_tau, tilde_s, tilde_b, tilde_phi,
                     ...
                     specific_enthalpy, extrinsic_curvature,
    ...
    return Sources.source_tilde_tau(
        ...
        specific_enthalpy, lorentz_factor, pressure, lapse, d_lapse, d_shift,
        spatial_metric, d_spatial_metric, inv_spatial_metric,
