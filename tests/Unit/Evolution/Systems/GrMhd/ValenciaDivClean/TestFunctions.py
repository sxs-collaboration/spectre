...
def characteristic_speeds(lapse, shift, spatial_velocity,
    ...
    for i in range(0, spatial_velocity.size + 3):
...
def tilde_d(rest_mass_density, specific_internal_energy, specific_enthalpy,
            pressure, electron_fraction, spatial_velocity, lorentz_factor,
...
def tilde_electron_d(rest_mass_density, specific_internal_energy,
                     specific_enthalpy, pressure, electron_fraction,
                     spatial_velocity, lorentz_factor, magnetic_field,
                     sqrt_det_spatial_metric, spatial_metric,
                     divergence_cleaning_field):
    return (electron_fraction * lorentz_factor * rest_mass_density *
            sqrt_det_spatial_metric)
...
def tilde_d_flux(tilde_d, tilde_tau, tilde_s, tilde_electron_d, tilde_b,
                 tilde_phi, lapse, shift, sqrt_det_spatial_metric,
                 spatial_metric, inv_spatial_metric, pressure,
                 spatial_velocity, lorentz_factor, magnetic_field):
    return tilde_d * (lapse * spatial_velocity - shift)


def tilde_tau_flux(tilde_d, tilde_tau, tilde_s, tilde_electron_d, tilde_b,
                   tilde_phi, lapse, shift, sqrt_det_spatial_metric,
                   spatial_metric, inv_spatial_metric, pressure,
                   spatial_velocity, lorentz_factor, magnetic_field):
    b_dot_v_ = b_dot_v(magnetic_field, spatial_velocity, spatial_metric)
...
def tilde_s_flux(tilde_d, tilde_tau, tilde_s, tilde_electron_d, tilde_b,
                 tilde_phi, lapse, shift, sqrt_det_spatial_metric,
                 spatial_metric, inv_spatial_metric, pressure,
                 spatial_velocity, lorentz_factor, magnetic_field):
    b_dot_v_ = b_dot_v(magnetic_field, spatial_velocity, spatial_metric)
...
def tilde_electron_d_flux(tilde_d, tilde_tau, tilde_s, tilde_electron_d,
                          tilde_b, tilde_phi, lapse, shift,
                          sqrt_det_spatial_metric, spatial_metric,
                          inv_spatial_metric, pressure, spatial_velocity,
                          lorentz_factor, magnetic_field):
    return tilde_electron_d * (lapse * spatial_velocity - shift)


def tilde_b_flux(tilde_d, tilde_tau, tilde_s, tilde_electron_d, tilde_b,
                 tilde_phi, lapse, shift, sqrt_det_spatial_metric,
                 spatial_metric, inv_spatial_metric, pressure,
                 spatial_velocity, lorentz_factor, magnetic_field):
...
def tilde_phi_flux(tilde_d, tilde_tau, tilde_s, tilde_electron_d, tilde_b,
                   tilde_phi, lapse, shift, sqrt_det_spatial_metric,
                   spatial_metric, inv_spatial_metric, pressure,
                   spatial_velocity, lorentz_factor, magnetic_field):
