...
def dg_package_data_tilde_d(tilde_d, tilde_ye, tilde_tau, tilde_s, tilde_b,
                            tilde_phi, flux_tilde_d, flux_tilde_ye,
                            flux_tilde_tau, flux_tilde_s, flux_tilde_b,
                            flux_tilde_phi, lapse, shift, normal_covector,
                            normal_vector, mesh_velocity,
                            normal_dot_mesh_velocity):
    return tilde_d


def dg_package_data_tilde_ye(tilde_d, tilde_ye, tilde_tau, tilde_s, tilde_b,
                             tilde_phi, flux_tilde_d, flux_tilde_ye,
                             flux_tilde_tau, flux_tilde_s, flux_tilde_b,
                             flux_tilde_phi, lapse, shift, normal_covector,
                             normal_vector, mesh_velocity,
...
def dg_package_data_tilde_tau(tilde_d, tilde_ye, tilde_tau, tilde_s, tilde_b,
                              tilde_phi, flux_tilde_d, flux_tilde_ye,
                              flux_tilde_tau, flux_tilde_s, flux_tilde_b,
                              flux_tilde_phi, lapse, shift, normal_covector,
                              normal_vector, mesh_velocity,
...
def dg_package_data_tilde_s(tilde_d, tilde_ye, tilde_tau, tilde_s, tilde_b,
                            tilde_phi, flux_tilde_d, flux_tilde_ye,
                            flux_tilde_tau, flux_tilde_s, flux_tilde_b,
                            flux_tilde_phi, lapse, shift, normal_covector,
                            normal_vector, mesh_velocity,
...
def dg_package_data_tilde_b(tilde_d, tilde_ye, tilde_tau, tilde_s, tilde_b,
                            tilde_phi, flux_tilde_d, flux_tilde_ye,
                            flux_tilde_tau, flux_tilde_s, flux_tilde_b,
                            flux_tilde_phi, lapse, shift, normal_covector,
                            normal_vector, mesh_velocity,
...
def dg_package_data_tilde_phi(tilde_d, tilde_ye, tilde_tau, tilde_s, tilde_b,
                              tilde_phi, flux_tilde_d, flux_tilde_ye,
                              flux_tilde_tau, flux_tilde_s, flux_tilde_b,
                              flux_tilde_phi, lapse, shift, normal_covector,
                              normal_vector, mesh_velocity,
...
def dg_package_data_normal_dot_flux_tilde_ye(
    tilde_d, tilde_ye, tilde_tau, tilde_s, tilde_b, tilde_phi, flux_tilde_d,
    flux_tilde_ye, flux_tilde_tau, flux_tilde_s, flux_tilde_b, flux_tilde_phi,
    lapse, shift, normal_covector, normal_vector, mesh_velocity,
    normal_dot_mesh_velocity):
    return np.dot(flux_tilde_ye, normal_covector)
...
def dg_package_data_abs_char_speed(tilde_d, tilde_ye, tilde_tau, tilde_s,
                                   tilde_b, tilde_phi, flux_tilde_d,
                                   flux_tilde_ye, flux_tilde_tau, flux_tilde_s,
...
def dg_boundary_terms_tilde_d(
    ...
    interior_normal_dot_flux_tilde_phi, interior_abs_char_speed,
    exterior_tilde_d, exterior_tilde_ye, exterior_tilde_tau, exterior_tilde_s,
...
def dg_boundary_terms_tilde_ye(
    ...
    use_strong_form):
    if use_strong_form:
        return -0.5 * (interior_normal_dot_flux_tilde_ye +
                       exterior_normal_dot_flux_tilde_ye) - 0.5 * np.maximum(
                           interior_abs_char_speed, exterior_abs_char_speed
                       ) * (exterior_tilde_ye - interior_tilde_ye)
    else:
        return 0.5 * (interior_normal_dot_flux_tilde_ye -
                      exterior_normal_dot_flux_tilde_ye) - 0.5 * np.maximum(
                          interior_abs_char_speed, exterior_abs_char_speed) * (
