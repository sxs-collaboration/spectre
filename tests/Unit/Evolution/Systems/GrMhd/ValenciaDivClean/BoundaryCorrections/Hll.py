...
def dg_boundary_terms_tilde_d(
    ...
    interior_largest_ingoing_char_speed, exterior_tilde_d, exterior_tilde_ye,
    ...
    if use_strong_form:
        return (lambda_min *
                (interior_normal_dot_flux_tilde_ye +
                 exterior_normal_dot_flux_tilde_ye) + lambda_max * lambda_min *
                (exterior_tilde_ye - interior_tilde_ye)) / (lambda_max -
                                                            lambda_min)
    else:
        return ((lambda_max * interior_normal_dot_flux_tilde_ye + lambda_min *
                 exterior_normal_dot_flux_tilde_ye) + lambda_max * lambda_min *
                (exterior_tilde_ye - interior_tilde_ye)) / (lambda_max -
                                                            lambda_min)
