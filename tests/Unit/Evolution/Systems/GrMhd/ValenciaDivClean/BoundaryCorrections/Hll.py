...
def dg_package_data_largest_outgoing_char_speed(
    ...
    if normal_dot_mesh_velocity is None:
        ...
        return lapse - np.dot(shift, normal_covector) - normal_dot_mesh_velocity
    ...
    if use_strong_form:
        return (
            ...
            * (
            ...
            + lambda_max * lambda_min * (exterior_tilde_d - interior_tilde_d)
        ) / (lambda_max - lambda_min)
    else:
        return (
            (
                lambda_max * interior_normal_dot_flux_tilde_d
                + lambda_min * exterior_normal_dot_flux_tilde_d
            )
            + lambda_max * lambda_min * (exterior_tilde_d - interior_tilde_d)
        ) / (lambda_max - lambda_min)
    ...
    if use_strong_form:
        return (
            ...
            * (
            ...
            + lambda_max * lambda_min * (exterior_tilde_ye - interior_tilde_ye)
        ) / (lambda_max - lambda_min)
    else:
        return (
            (
                lambda_max * interior_normal_dot_flux_tilde_ye
                + lambda_min * exterior_normal_dot_flux_tilde_ye
            )
            + lambda_max * lambda_min * (exterior_tilde_ye - interior_tilde_ye)
        ) / (lambda_max - lambda_min)
...
def dg_boundary_terms_tilde_tau(
    ...
    if use_strong_form:
        ...
        return (
            (
                lambda_max * interior_normal_dot_flux_tilde_tau
    ...
    if use_strong_form:
        return (
            ...
            * (
            ...
            + lambda_max * lambda_min * (exterior_tilde_s - interior_tilde_s)
        ) / (lambda_max - lambda_min)
    else:
        return (
            (
                lambda_max * interior_normal_dot_flux_tilde_s
                + lambda_min * exterior_normal_dot_flux_tilde_s
            )
            + lambda_max * lambda_min * (exterior_tilde_s - interior_tilde_s)
        ) / (lambda_max - lambda_min)
    ...
    if use_strong_form:
        return (
            ...
            * (
            ...
            + lambda_max * lambda_min * (exterior_tilde_b - interior_tilde_b)
        ) / (lambda_max - lambda_min)
    else:
        return (
            (
                lambda_max * interior_normal_dot_flux_tilde_b
                + lambda_min * exterior_normal_dot_flux_tilde_b
            )
            + lambda_max * lambda_min * (exterior_tilde_b - interior_tilde_b)
        ) / (lambda_max - lambda_min)
...
def dg_boundary_terms_tilde_phi(
    ...
    if use_strong_form:
        ...
        return (
            (
                lambda_max * interior_normal_dot_flux_tilde_phi
