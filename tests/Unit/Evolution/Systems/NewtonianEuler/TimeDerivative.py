...
def source_mass_density_cons_impl(first_arg, second_arg, third_arg, fourth_arg):
...
def source_mass_density_cons(
    ...
    return source_mass_density_cons_impl(
...
def source_momentum_density(
    ...
    return source_momentum_density_impl(
        first_arg, second_arg, third_arg, fourth_arg
    )
...
def source_energy_density(
    ...
    return source_energy_density_impl(
        first_arg, second_arg, third_arg, fourth_arg
    )


def minus_one_mass_density(
    momentum_density,
    energy_density,
    velocity,
    pressure,
    ...
    return minus_one_mass_density_impl(
        first_arg, second_arg, third_arg, fourth_arg
    )
