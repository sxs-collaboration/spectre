...
def hamiltonian_sources(
    ...
    return (
        conformal_factor**5 * extrinsic_curvature_trace**2 / 12.0
        - 2.0
        * pi
        * conformal_factor ** (5 - conformal_matter_scale)
        * conformal_energy_density
    )
...
def linearized_hamiltonian_sources(
    ...
    return (
        5.0 * conformal_factor**4 * extrinsic_curvature_trace**2 / 12.0
        - 2.0
        * pi
...
def curved_hamiltonian_or_lapse_sources(conformal_ricci_scalar, field):
    return field * conformal_ricci_scalar / 8.0
...
def lapse_sources(
    ...
    return lapse_times_conformal_factor * conformal_factor**4 * (
        ...
        * (conformal_energy_density + 2.0 * conformal_stress_trace)
        / conformal_factor**conformal_matter_scale
    ) + conformal_factor**5 * (
    ...
    return (
        ...
        * (
            ...
            * conformal_factor_correction
            ...
            - 2.0
            * conformal_factor**7
            / lapse_times_conformal_factor**3
            * lapse_times_conformal_factor_correction
        )
        * longitudinal_shift_minus_dt_conformal_metric_square
    )
...
def momentum_sources(
    ...
    return (
        np.einsum(
            ...
            - 7.0 * conformal_factor_flux / conformal_factor,
        )
        - minus_div_dt_conformal_metric
        + 4.0
        / 3.0
...
def linearized_momentum_sources(
    ...
    return (
        ...
        * (
            ...
            * lapse_times_conformal_factor
            * conformal_factor ** (2 - conformal_matter_scale)
            * conformal_factor_correction
            + conformal_factor ** (3 - conformal_matter_scale)
            * lapse_times_conformal_factor_correction
        )
