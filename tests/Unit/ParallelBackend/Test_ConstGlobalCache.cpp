...
#include "tests/Unit/ParallelBackend/Test_ConstGlobalCache.hpp"
...
SPECTRE_TEST_CASE("Unit.ParallelBackend.ConstGlobalCache",
                  "[Unit][ParallelBackend]") {
  {
...
#include "src/ParallelBackend/ConstGlobalCache.def.h"  // IWYU pragma: keep

#include "tests/Unit/ParallelBackend/Test_ConstGlobalCache.def.h"  // IWYU pragma: keep
