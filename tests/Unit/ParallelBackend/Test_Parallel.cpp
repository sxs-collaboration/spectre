...
SPECTRE_TEST_CASE("Unit.ParallelBackend.printf", "[Unit][ParallelBackend]") {
  ...
  // The Unit.ParallelBackend.printf does not need to check anything
  CHECK(true);
}

SPECTRE_TEST_CASE("Unit.ParallelBackend.NodeAndPes",
